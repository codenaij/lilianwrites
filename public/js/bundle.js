...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"blog.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.saveContact = exports.saveSubscription = exports.saveBlog = void 0;
...
var saveBlog = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Blog Posted Successfully'); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
...
var saveSubscription = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You have subscribed to our newsletter');
            }
  ...
  return function saveSubscription(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var saveContact = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(firstName, lastName, email, phone, message) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
  ...
  return function saveContact(_x3, _x4, _x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();
...
var logOutBtn = document.querySelector('.nav-logoutbtn');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var adminPostBlogForm = document.querySelector('.form-admin-blog');
var subscribeEmail = document.querySelector('.subscribe');
var contactForm = document.querySelector('.contact-form');
var registerForm = document.querySelector('.register'); // DELEGATION
...
if (adminPostBlogForm) {
  adminPostBlogForm.addEventListener('submit', function (e) {
    e.preventDefault(); // const title = document.getElementById('blogtitle').value;
    ...
    data.append('author', document.getElementById('blogauthor').value); // data.append('photo', document.getElementById('photo').files[0]);

    (0, _blog.saveBlog)(data);
  });
}
...
if (subscribeEmail) {
  subscribeEmail.addEventListener('submit', function (e) {
    ...
    (0, _blog.saveSubscription)(email);
...
if (contactForm) {
  contactForm.addEventListener('submit', function (e) {
    ...
    (0, _blog.saveContact)(firstName, lastName, email, phone, message);
